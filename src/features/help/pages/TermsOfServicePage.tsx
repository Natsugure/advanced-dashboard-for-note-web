...
export function TermsOfServicePage() {
  return (
    <Container mt="xl" mb="xl">
      ...
      <Text>
        本利用規約（以下「本規約」といいます）は、なつぐれ（以下「サービス提供者」といいます）が提供するWebサービス「Advanced Dashboard for note」（以下「本サービス」といいます）の利用条件を定めるものです。ユーザーの皆様には、本規約に同意いただいた上で、本サービスをご利用いただきます。
      </Text>

      <Title order={2} mt="xl">2. 本サービスの概要</Title>
      <Text>
        本サービスは、note株式会社様が提供するサービス「note（https://note.com）」から各記事のアクセス状況を取得し、データをユーザーが見やすい形にして提供する非公式のサービスです。
      </Text>
