...
export function PrivacyPolicyPage() {
  return (
    <Container mt="xl" mb="xl">
      ...
      <Text>
        なつぐれ（以下「サービス提供者」といいます）は、Webサービス「Advanced Dashboard for note」（以下「本サービス」といいます）におけるユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」といいます）を定めます。
      </Text>
      ...
      <Text>
        本サービスは、noteのAPIを利用してサービスを提供しています。noteのプライバシーポリシーについては、noteの公式サイトをご確認ください。
      </Text>
